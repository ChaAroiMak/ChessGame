...
//    private TicTacToePiece pickResult;
     ...
     * @param name
     */
    public ChessTCPProtocolEngine(ChessGame gameEngine, String name) {
        this.gameEngine = gameEngine;
        this.name = name;
    }

    public ChessTCPProtocolEngine(ChessGame gameEngine) {
        this.gameEngine = gameEngine;
    }

    public boolean set(ChessPieceColor color, ChessBoardPosition position) throws GameException {
        this.log("send set message to other side");
        this.serializeSet(color, position, this.os);
        return false;
    }
...
//                case RESULT_PICK: this.deserializeResultPick(); return true;
    ...
    public void run() {
        ...
        this.notifyGamesSessionEstablished(ChessTCPProtocolEngine.this.oracle,
                ChessTCPProtocolEngine.this.partnerName);
